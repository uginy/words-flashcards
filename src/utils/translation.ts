...
const sampleTranslations: Record<string, { russian: string; transcription: string; category: WordCategory; conjugation?: string }> = {
  ...
  'מידע': { russian: 'информация', transcription: 'мейда', category: 'noun' },
  'כמות': { russian: 'количество', transcription: 'камут', category: 'noun' },
  'אחריות': { russian: 'ответственность', transcription: 'ахраюt', category: 'noun' },
  ...
  'להציע את ל': { russian: 'предлагать кому-либо', transcription: 'леация эт ле', category: 'verb', conjugation: 'מציע, הציע, יציע' },
  'להתבגר': { russian: 'взрослеть', transcription: 'леитбагер', category: 'verb', conjugation: 'מתבגר, התבגר, יתבגר' },
  ...
  'מרוכז-ת': { russian: 'сосредоточенный(-ая)', transcription: 'мерухаз-эт', category: 'adjective' },
