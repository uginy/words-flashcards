...
// LM Studio-specific processor that matches by array position instead of hebrew field
export function processWordsArrayLMStudio(llmItems: LLMBatchResponseItem[], originalWords: string[]): Word[] {
