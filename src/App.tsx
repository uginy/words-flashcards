...
function App() {
  ...
  useEffect(() => {
    if (words.length === 0) {
      const defaultHebrewWords = `ניסיון מוצר מידע כמות אחריות יכולת להשפיע על לבחור ב, את להתלבט בין לבין להתחרט על להציע את ל להתבגר להתווכח להתרכז מתבגר-ת אחראי-ת מוכשר-ת מבולבל-ת מרוכז-ת היכן`;
      addWords(defaultHebrewWords);
    }
